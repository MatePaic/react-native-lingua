...
After successful verification/authentication, navigate to the home route (/). If not authenticated, show the onboarding route (/onboarding). If authenticated, show the home route (/).
